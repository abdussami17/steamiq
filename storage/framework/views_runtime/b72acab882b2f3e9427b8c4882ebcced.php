                            ...
                            <tbody>
                                <?php $__empty_1 = true; $__currentLoopData = $logs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $log): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <button type="button"
                                                class="btn btn-sm btn-danger history-unassign-btn"
                                                data-assignment-id="<?php echo e($log->id); ?>"
                                                data-card-type="<?php echo e($log->card->type); ?>">
                                                <i data-lucide="x"></i>
                                            </button>
                                        </td>
                                    </tr>
                        ...
                        <script>
                            document.addEventListener('DOMContentLoaded', function () {
                                ...
                                document.addEventListener('click', async function (e) {
                                    ...
                                    const btn = e.target.closest('.history-unassign-btn');
                            
                                    if (!btn) return;
                            
                                    const assignmentId = btn.dataset.assignmentId;
                                    const cardType = btn.dataset.cardType || 'card';
                            
                                    const ok = confirm(`Unassign this ${cardType.toUpperCase()} card?`);
                                    ...
                                    try {
                                        ...
                                        const response = await fetch(`/card-assignments/${assignmentId}`, {
                                            method: 'DELETE',
                                            headers: {
                                        ...
                                        Swal.fire({
                                            icon: 'success',
                                            title: 'Success',
                                            text: 'Card unassigned successfully!',
                                            timer: 1800,
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\PC\Desktop\steam-two\resources\views/settings/index.blade.php ENDPATH**/ ?>