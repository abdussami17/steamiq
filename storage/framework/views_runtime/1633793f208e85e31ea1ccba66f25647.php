...
document.getElementById('exportGameCardBtn').addEventListener('click', function () {
    ...
    const url      = new URL('<?php echo e(route("rosters.export.game-cards")); ?>', window.location.origin);
    if (eventId) url.searchParams.set('event_id', eventId);
    ...
    </script><?php /**PATH C:\Users\PC\Downloads\steam-two\resources\views/roster/script/script.blade.php ENDPATH**/ ?>