<div class="modal fade" id="matchModal" tabindex="-1">
          ...
          <div class="modal-body">
            ...
            <div class="row g-3 mt-1">
              <div class="col-md-6">
                ...
                <input type="date" class="form-input" id="matchDate" value="<?php echo e(date('Y-m-d')); ?>">
              </div>
              <div class="col-md-6">
                <label class="form-label">Time</label>
                <input type="time" class="form-input" id="matchTime" value="<?php echo e(date('H:i')); ?>">
              </div>
            </div>
          </div>
  ...
  <?php /**PATH /home/u236413684/domains/voags.com/public_html/steamiq/resources/views/matches/modals/add-match.blade.php ENDPATH**/ ?>