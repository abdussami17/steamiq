<div class="modal fade" id="assignBonusModal" tabindex="-1">
    <div class="modal-dialog">
        <form action="{{ route('bonus.assign.store') }}" method="POST" id="assignBonusFormUnique98765">
            @csrf
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <!-- First Level -->
                    <div class="mb-3" id="firstLevelContainerUnique98765" style="display:none;">
                    ...
                    <!-- Second Level -->
                    <div class="mb-3" id="secondLevelContainerUnique98765" style="display:none;">
                    ...
                    <!-- Direct -->
                    <div class="mb-3" id="directContainerUnique98765" style="display:none;">
