{{--
    Mobile Orientation & Pinch Hint Component
    ==========================================
    Usage: @include('components.mobile-hint')
           OR <x-mobile-hint />

    To use as an anonymous component (x-mobile-hint), place this file at:
    resources/views/components/mobile-hint.blade.php

    LocalStorage key: 'hideOrientationHint'
    Cookie fallback: 'hide_orientation_hint' (set via JS, read server-side if needed)
--}}
...
{{-- Floating trigger shown after dismissal (without "don't show again") --}}
<button type="button"
